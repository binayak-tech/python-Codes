...
#  APPROACH 1
'''
THIS APPROACH IS ONLY SUITABLE IF ONLY 1 NUMBER IS REPEATED TWICE

def repeatedNumber(A):
      opMap = {}
      output = []
      
      # it has been told that the input is tuple
      # therefore we are converting it into list because removing element is not possible in tuple
      A = list(A)
      length = len(A)
